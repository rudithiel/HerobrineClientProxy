...
public class ServerMigrationForwarder extends SessionAdapter {
	...
	public void packetReceived(PacketReceivedEvent event) {
		...
		if (packet instanceof LoginSetCompressionPacket) {
			...
			//proxySession.getServer().disconnect("Finished.", false); // TODO make certain its ok to not wait for old server connection to close.
			...
			PacketForwarder forwarder = new PacketForwarder(proxySession.getClient());
